...
export default function DcaTable() {
  ...
  useEffect(() => {
    // to stop hydration errors when new dca cion is added causing different server and client HTML
    setMounted(true);
  }, []);
  ...
  return (
    <div
      className="mb-5 max-w-[800px] w-full overflow-x-auto sm:overflow-hidden rounded-xl"
      aria-label="DCA Table"
    >
