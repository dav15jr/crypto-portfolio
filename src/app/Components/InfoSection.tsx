...
export default function InfoSection() {
  ...
  return (
    <section className='flex flex-col justify-center items-center mb-10' aria-label="Info section">
        ...
        <div className='md:flex justify-center items-center max-w-[350px] md:max-w-[1000px] p-2'>
            <div className='flex flex-col justify-center items-center mt-8 md:px-5'>
                <Handshake className='text-green-700 m-5' height={40} width={40} aria-label="handshake icon"/>
            ...
            <div className='flex flex-col justify-center items-center mt-8  md:px-5'>
                <Fingerprint className='text-green-700 m-5' height={40} width={40} aria-label="fingerprint icon"/>
            ...
            <div className='flex flex-col justify-center items-center mt-8 md:px-5'>
                <SearchCheck className='text-green-700 m-5' height={40} width={40} aria-label="search check icon"/>
